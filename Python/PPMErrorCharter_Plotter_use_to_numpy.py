...
def plot_histograms(outputFilePath, columnNames, mass_error_ppm, counts_original, counts_refined, title_original, title_refined):
    ...
    ax1.plot(mass_error_ppm.to_numpy(), counts_original.to_numpy(), linewidth=1, color='blue')

    ax2.plot(mass_error_ppm.to_numpy(), counts_refined.to_numpy(), linewidth=1, color='green')
...
def plot_mass_errors(outputFilePath, errorVsTimeColumnNames, errorVsMassColumnNames, 
    ...
    ax1.scatter(scan_times.to_numpy(), scan_mass_errors_original.to_numpy(), s=scale, color='blue', alpha=0.4, label=scan_title_original)
    ax2.scatter(scan_times.to_numpy(), scan_mass_errors_refined.to_numpy(),  s=scale, color='blue', alpha=0.4, label=scan_title_refined)

    ax3.scatter(mz_list.to_numpy(), mz_mass_errors_original.to_numpy(), s=scale, color='green', alpha=0.4, label=mz_title_original)
    ax4.scatter(mz_list.to_numpy(), mz_mass_errors_refined.to_numpy(),  s=scale, color='green', alpha=0.4, label=mz_title_refined)
